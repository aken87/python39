...
print('Элемент -1 -', shoplist[-1]) # последний элемент последовательности
print('Элемент -2 -', shoplist[-2]) # предпоследний элемент 
...
# которой вырезка должна начинаться,
# а второе число (после двоеточия) указывает, где вырезка должна закончиться
